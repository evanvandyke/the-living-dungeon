...
Read `PROJECT.md` for the project brief and `RESEARCH.md` for API/library research findings. The Researcher has already investigated the services and documented capabilities, constraints, and gotchas. Use their findings to inform your architecture — don't make assumptions about APIs that contradict the research.

Your job is to make all the architecture decisions and produce two documents:
...
## Guidelines
- `RESEARCH.md` is required reading. The Researcher ran before you. Base your architecture on what the APIs actually support, not what you assume they support.
